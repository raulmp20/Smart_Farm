...
public class ConfigActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText email_att;
        email_att = findViewById(R.id.email_ref);
        EditText senha_att;
        senha_att = findViewById(R.id.senha_atualiza);
        EditText confirm_senha_att;
        confirm_senha_att = findViewById(R.id.confirm_senha_atualiza);
        EditText pin_att;
        pin_att = findViewById(R.id.confirm_pin_atualiza);
        // Botão "Enviar Pin"
        Button enviaPin;
        enviaPin = findViewById(R.id.button_envia_pin);
        // Botão "salvar"
        Button salvar;
        ...
        CheckBox esconderSenha = findViewById(R.id.oculta_senhaConfig);
        ...
        // Botão de ocultar senha
        CheckBox esconderSenhaConfirm = findViewById(R.id.oculta_confirmSenhaConfig);
        // Verifica se a caixa está selecionada
        ...
        salvar.setOnClickListener(v -> {
            ...
            if (senhaNova.equals(confirmSenhaNova) && !confirmSenhaNova.isEmpty()) {
                ...
                Toast.makeText(ConfigActivity.this, "As senhas não se coincidem", Toast.LENGTH_SHORT).show();
            }
            if(senhaNova.isEmpty()) {
                Toast.makeText(ConfigActivity.this, "Insira uma senha", Toast.LENGTH_SHORT).show();
            }
            if(confirmSenhaNova.isEmpty()) {
                Toast.makeText(ConfigActivity.this, "Insira uma confirmação de senha", Toast.LENGTH_SHORT).show();
            }
            if (email.isEmpty()) {
                Toast.makeText(ConfigActivity.this, "Insira um e-mail", Toast.LENGTH_SHORT).show();
            }
        });
        // Voltando ao menu
        voltar.setOnClickListener(v -> {
            // Mudando a tela para a tela menu
            Intent mudar = new Intent(ConfigActivity.this, MenuActivity.class);
            startActivity(mudar);
        });
    }
            ...
            public void messageArrived(String topic, MqttMessage mqttMessage) throws Exception {
                ...
                if (topic.equals("Smart_Farm/Atualiza/Status")) {
                    switch (mqttMessage.toString()) {
                        ...
                        case ("00"):
                            Toast.makeText(ConfigActivity.this, "E-mail não encontrado", Toast.LENGTH_SHORT).show();
                            break;
                        case ("10"):
                            Toast.makeText(ConfigActivity.this, "Pin inválido", Toast.LENGTH_SHORT).show();
                            break;
                        case ("11"):
                            Toast.makeText(ConfigActivity.this, "Senha atualizada", Toast.LENGTH_SHORT).show();
                            Intent SenhaTrocada = new Intent(ConfigActivity.this, LoginActivity.class);
                ...
                if(topic.equals("Smart_Farm/Atualiza/StatusPin")) {
                    switch (mqttMessage.toString()) {
                        case ("0"):
                            ...
                            break;
                        case ("1"):
                            Toast.makeText(ConfigActivity.this, "Pin Enviado", Toast.LENGTH_SHORT).show();
                            break;
                        default:
                            break;
                    }
